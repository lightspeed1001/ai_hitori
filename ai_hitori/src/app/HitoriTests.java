...
public class HitoriTests 
{
    ...
    public static HitoriCell[][] getSolvedPuzzle(int i)
    {
        switch (i) {
            case 0: //#????
    ...
    public static Set<HitoriCell[][]> getTestCase(int i)
    {
        ...
        switch (i) {
            case 0:
                ...
                HitoriCell[][] solution1 = getSolvedPuzzle(i);
            ...
            case 1:
                ...
                HitoriCell[][] solved2 = getSolvedPuzzle(i);
            ...
            case 2: 
                ...
                HitoriCell[][] solved3 = getSolvedPuzzle(i);
            ...
            default:
                ...
                HitoriCell[][] solutionDefault = getSolvedPuzzle(0);
